...
namespace Information_System_Galicia {
    public partial class StudentInfo : Form {
        ...
        public void searchStudent() {
            try {
                ...
                if (dr.Read()) {
                    ...
                    var bd = dr.GetString(5).Split(' ');
                    this.bdayM.Text = bd[0]; // month combo box text
                    this.bdayD.Text = bd[1]; // day combo box text
                    this.bdayY.Text = bd[2]; // year combo box text
        ...
        {
            this.Hide();
            printInd ind = new printInd();
            ind.studid = this.studid;
            ind.Show();
        }
    }
}